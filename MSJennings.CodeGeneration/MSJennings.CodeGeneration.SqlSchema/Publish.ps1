$version = (Get-Item bin\Debug\*\MSJennings.CodeGeneration.SqlSchema.dll).VersionInfo.FileVersion | Select-Object -first 1

Add-Type -AssemblyName System.IO.Compression.FileSystem

$nupkgFilename = "$(Get-Location)\bin\Debug\MSJennings.CodeGeneration.SqlSchema.1.0.0.nupkg"
